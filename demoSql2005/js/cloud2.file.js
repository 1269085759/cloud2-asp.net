...
function FileUploader(fileLoc, mgr)
{
    ...
    this.md5_complete = function (json)
    {
        ...
        var param = jQuery.extend({}, this.fields, { cloud: JSON.stringify(this.Config.Cloud), md5: json.md5, lenLoc: loc_len, sizeLoc: loc_size, pathLoc: loc_path, time: new Date().getTime() });
